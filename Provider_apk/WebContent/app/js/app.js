...
function ($stateProvider, $locationProvider, $urlRouterProvider, helper) {
  ...
  // You may have to set <base> tag in index and a routing configuration in
	// your server
...
App
  ...
  .constant('APP_REQUIRES', {
    ...
    modules: [
      // { name: 'toaster', files:
		// ['vendor/angularjs-toaster/toaster.js','vendor/angularjs-toaster/toaster.css']
		// }
/*
  ...
  function($rootScope, $scope, $state, $translate, $window, $localStorage, $timeout, toggle, colors, browser, cfpLoadingBar) {
    ...
    $scope.language = {
      ...
      init: function () {
        ...
        var preferredLanguage = $translate.preferredLanguage(); // we know we
																// have set a
																// preferred one
																// in app.config
 ...
 * 
 * 
 * angular .module('app.elements') .controller('SweetAlertController',
 * SweetAlertController);
 * 
 * SweetAlertController.$inject = ['SweetAlert']; function
 * SweetAlertController(SweetAlert) { var vm = this;
 * 
 * activate();
 */
        // //////////////
       ...
       /*
		 * function activate() { vm.demo1 = function() {
		 * SweetAlert.swal('Here\'s a message'); };
		 * 
		 * vm.demo2 = function() { SweetAlert.swal('Here\'s a message!', 'It\'s
		 * pretty, isn\'t it?'); };
		 * 
		 * vm.demo3 = function() { SweetAlert.swal('Good job!', 'You clicked the
		 * button!', 'success'); };
		 * 
		 * vm.demo4 = function() { SweetAlert.swal({ title: 'Are you sure?',
		 * text: 'Your will not be able to recover this imaginary file!', type:
		 * 'warning', showCancelButton: true, confirmButtonColor: '#DD6B55',
		 * confirmButtonText: 'Yes, delete it!', closeOnConfirm: false },
		 * function(){ SweetAlert.swal('Booyah!'); }); };
		 * 
		 * vm.demo5 = function() { SweetAlert.swal({ title: 'Are you sure?',
		 * text: 'Your will not be able to recover this imaginary file!', type:
		 * 'warning', showCancelButton: true, confirmButtonColor: '#DD6B55',
		 * confirmButtonText: 'Yes, delete it!', cancelButtonText: 'No, cancel
		 * plx!', closeOnConfirm: false, closeOnCancel: false },
		 * function(isConfirm){ if (isConfirm) { SweetAlert.swal('Deleted!',
		 * 'Your imaginary file has been deleted.', 'success'); } else {
		 * SweetAlert.swal('Cancelled', 'Your imaginary file is safe :)',
		 * 'error'); } }); };
		 */

         /*
			 * $scope.demo6 = function() { SweetAlert.swal({ title: 'Sweet!',
			 * text: 'Here\'s a custom image.', imageUrl:
			 * 'http://oitozero.com/img/avatar.jpg' }); };
			 */
    // }
  // }
    	   ...
    	   try {
                          ...
                          url: 'http://10.44.54.9:3000/getMeetURL?RequestId='+$scope.requestedId
                            ...
                            console.log("not fetched url");
										...
										/*
										 * swal({ html : true, title : '<div>'+ '<p>Waiting
										 * for your meet URL</p>'+ '<div
										 * class="loaderImageBG"
										 * ng-hide="loadingVisible">'+ '<h1>hello
										 * <a href={{meetURL}} /></h1>'+ '</div>'+ '<div
										 * class="loaderImageBG"
										 * ng-show="loadingVisible">'+ '<img
										 * style="margin-top: 50%;"
										 * src="app/img/images/loading.gif">'+ '</div>'+ '</div>',
										 */
                  /*
					 * title : '<p style="font-size:20pt;margin-top:-0.5%;font-family:Roboto,sans-serif;font-weight:normal;">Spend
					 * Deposit</p><br/><br/><div id="div1" align="center"><img
					 * id="overlay1" src="app/img/icon_fuel.png" align="center"
					 * style="margin-top:-15%;width:100px;"></img><p style="font-size:20pt;color:#DE5554;font-family:Roboto,sans-serif;font-weight:normal;margin-top: 10px;margin-bottom: 0px;" align="center">'+$scope.cat+'&nbsp;<em class="fa fa-rupee"></em>
					 * '+$scope.amt+'</p><small
					 * style="font-size:12pt;color:#9F9EA1;font-family:Roboto,sans-serif;font-weight:normal;">Date:
					 * '+$scope.todayDate +'</small></div>'+ '<p style="margin-top: 0px;line-height:40px;margin-bottom: 0px;"  ><a
					 * href="#" onClick="performSpendDepositOperation('+fuel+')"
					 * style="font-size:13pt;color:#52A0CD;font-family:Roboto,sans-serif;font-weight:normal;"
					 * align="center;">Spend From Deposit</a><br/><a href="#"
					 * onClick="performKeepDepositOperation('+fuel+')"
					 * style="font-size:13pt;color:#52A0CD;font-family:Roboto,sans-serif;font-weight:normal;"
					 * align="center;">Keep Deposit</a><br/><a href="#"
					 * onClick="performCreateNewOperation('+fuel+')"
					 * style="font-size:13pt;color:#52A0CD;font-family:Roboto,sans-serif;font-weight:normal;"
					 * align="center;">Create New</a></p>',
					 */     
                      
                     /*
						 * showConfirmButton : false, showCancelButton: false,
						 * confirmButtonColor: "#1aacda", cancelButtonText:
						 * "close", closeOnConfirm: false });
						 */
    ...
    return {
      ...
      support: {
        ...
        touch: (
            ...
            (window.navigator['msPointerEnabled'] && window.navigator['msMaxTouchPoints'] > 0) || // IE
																									// 10
